...
public class GalleryofENCONActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galleryof_e_n_c_o_n);
        ...
        mWebview.loadUrl("https://www.youtube.com/watch?v=VzANndmjiEU");
