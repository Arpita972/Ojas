...
public class AEERegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_e_e_registration);
        ...
        mWebview.loadUrl("https://www.aeecenter.org/membership/categories-dues");
